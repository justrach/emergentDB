...
export default function Home() {
  return (
    <div className="min-h-screen bg-[#09090B]">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-[#09090B]/80 backdrop-blur-lg border-b border-[#27272a]">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            ...
            <a href="#ingestion" className="text-sm text-zinc-400 hover:text-white transition-colors">
              Ingestion
            </a>
            <a
      ...
      <section id="ingestion" className="py-20 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <span className="mono-label text-[#298DFF]">Document Ingestion</span>
            <h2 className="text-3xl md:text-4xl font-bold mt-4 mb-4">
              Ingest Documents with Gemini OCR
            </h2>
            <p className="text-zinc-400 max-w-xl mx-auto">
              Use the Python CLI to ingest PDFs, images, and text files with automatic OCR and embedding generation.
            </p>
          </div>
...
python ingest.py interactive`}
            ...
            <div className="bg-[#0e0e13] rounded-xl overflow-hidden border border-[#27272a]">
              <div className="flex items-center gap-2 px-4 py-3 bg-[#141419] border-b border-[#27272a]">
                ...
                <div className="w-3 h-3 rounded-full bg-yellow-500" />
                <div className="w-3 h-3 rounded-full bg-green-500" />
                <span className="ml-3 text-xs text-zinc-500 font-mono">REST API</span>
              </div>
              <pre className="p-6 overflow-x-auto text-sm">
                <code className="font-mono text-zinc-300">
...
curl http://localhost:3000/ingest/stats`}
          ...
          <div className="grid md:grid-cols-4 gap-4 mt-8">
            <div className="bg-[#141419] rounded-lg p-4 border border-[#27272a]">
              ...
              <h4 className="font-medium text-sm mb-1">PDF Support</h4>
              <p className="text-xs text-zinc-500">Native PDF parsing with OCR fallback</p>
            </div>
            ...
            <div className="bg-[#141419] rounded-lg p-4 border border-[#27272a]">
              ...
              <h4 className="font-medium text-sm mb-1">Image OCR</h4>
              <p className="text-xs text-zinc-500">Gemini 3 Flash vision for images</p>
            </div>
            ...
            <div className="bg-[#141419] rounded-lg p-4 border border-[#27272a]">
              ...
              <h4 className="font-medium text-sm mb-1">768-dim Embeddings</h4>
              <p className="text-xs text-zinc-500">Gemini embedding-001 model</p>
            </div>
            ...
            <div className="bg-[#141419] rounded-lg p-4 border border-[#27272a]">
              ...
              <h4 className="font-medium text-sm mb-1">CLI + Interactive</h4>
              <p className="text-xs text-zinc-500">Command line or REPL mode</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-6 bg-[#0e0e13]">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-[#141419] rounded-xl overflow-hidden border border-[#27272a]">
            <div className="flex items-center gap-2 px-4 py-3 bg-[#1a1a1f] border-b border-[#27272a]">
              <div className="w-3 h-3 rounded-full bg-red-500" />
              <div className="w-3 h-3 rounded-full bg-yellow-500" />
              <div className="w-3 h-3 rounded-full bg-green-500" />
